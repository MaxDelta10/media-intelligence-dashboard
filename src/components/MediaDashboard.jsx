        ...
        <header style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '24px' }}>
          ...
          <div style={{ display: 'flex', borderBottom: '1px solid #e2e8f0', gap: '24px', marginTop: '4px' }}>
            {[
              ...
              { id: 'demographics', label: activeTab === 'social' ? 'Demographics & Locations' : 'Media & Locations' },
              { id: 'latest', label: activeTab === 'social' ? 'Latest Posts' : 'Latest Articles' }
            ].map(sec => (
              <button
                key={sec.id}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            ...
            {(activeSection === 'all' || activeSection === 'exposure') && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                {activeSection === 'all' && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', borderLeft: '4px solid #b91c1c', paddingLeft: '8px', marginTop: '8px' }}>
            ...
            {/* SECTION 3: DEMOGRAPHICS & LOCATIONS */}
            {(activeSection === 'all' || activeSection === 'demographics') && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                {activeSection === 'all' && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', borderLeft: '4px solid #b91c1c', paddingLeft: '8px', marginTop: '12px' }}>
                    <h2 style={{ fontSize: '15px', fontWeight: '700', color: '#1e293b', margin: 0 }}>Demographics & Locations Analysis</h2>
                  </div>
                )}
            ...
            {(activeSection === 'all' || activeSection === 'sentiment') && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                {activeSection === 'all' && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', borderLeft: '4px solid #b91c1c', paddingLeft: '8px', marginTop: '12px' }}>
                    <h2 style={{ fontSize: '15px', fontWeight: '700', color: '#1e293b', margin: 0 }}>Sentiment Analysis</h2>
                  </div>
                )}
            ...
            {(activeSection === 'all' || activeSection === 'latest') && (
              <div>
                {activeSection === 'all' && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', borderLeft: '4px solid #b91c1c', paddingLeft: '8px', marginTop: '12px', marginBottom: '16px' }}>
                    <h2 style={{ fontSize: '15px', fontWeight: '700', color: '#1e293b', margin: 0 }}>Latest Posts</h2>
                  </div>
                )}
                {activeSection !== 'all' && (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            ...
            {(activeSection === 'all' || activeSection === 'exposure') && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                {activeSection === 'all' && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', borderLeft: '4px solid #b91c1c', paddingLeft: '8px', marginTop: '8px' }}>
                    <h2 style={{ fontSize: '15px', fontWeight: '700', color: '#1e293b', margin: 0 }}>Exposure & Volume Analysis</h2>
                  </div>
                )}
            ...
            {/* SECTION 3: MEDIA & LOCATIONS */}
            {(activeSection === 'all' || activeSection === 'demographics') && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                {activeSection === 'all' && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', borderLeft: '4px solid #b91c1c', paddingLeft: '8px', marginTop: '12px' }}>
                    <h2 style={{ fontSize: '15px', fontWeight: '700', color: '#1e293b', margin: 0 }}>Media & Locations Analysis</h2>
                  </div>
                )}
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '20px' }}>
                  ...
                  {/* Top News Location Horizontal Bar Chart (Fix: No Gap, Track Background, 120px Labels) */}
            ...
            {(activeSection === 'all' || activeSection === 'latest') && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                {activeSection === 'all' && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', borderLeft: '4px solid #b91c1c', paddingLeft: '8px', marginTop: '12px' }}>
                    <h2 style={{ fontSize: '15px', fontWeight: '700', color: '#1e293b', margin: 0 }}>Latest Articles</h2>
                  </div>
                )}
